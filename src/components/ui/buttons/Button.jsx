function Button({
  ...
  const styles = {
    ...
    filter:
      "h-full w-full border border-pearl font-bebas text-lg font-medium uppercase tracking-widest transition-all duration-200 hover:text-offblack hover:border-zest hover:bg-zest/85",
  };
